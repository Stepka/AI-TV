      ...
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="rounded-[2rem] border border-zinc-700/50 bg-gradient-to-br from-zinc-900/90 to-zinc-800/50 p-8 shadow-2xl shadow-black/30 sm:p-10">
          ...
          <div className="space-y-5 text-base leading-8 text-zinc-300 sm:text-lg" style={{ fontFamily: 'Manrope, sans-serif' }}>
            <p>
              Логика сервиса строится на том, что в эфире используется не чужой популярный каталог и не фонограммы, права на которые обычно
              администрируются через коллективное управление, а специально сгенерированный сервисом контент для коммерческого использования.
            </p>
            <p>
              Если бизнес не использует произведения и фонограммы из обычного репертуара правообладателей, а работает с отдельным набором
              сгенерированных треков на основании договора с сервисом, то модель использования отличается от стандартного сценария публичного
              исполнения музыки из традиционного каталога.
            </p>
            <p>
              Именно поэтому ключевое значение имеют происхождение треков, условия передачи прав на использование и комплект документов, который
              подтверждает, что бизнес использует контент сервиса, а не стороннюю музыку из стриминга, радио или коммерческих библиотек.
            </p>
            <p>
              При этом для сетевых проектов, сложных внедрений и внутренних комплаенс-проверок мы рекомендуем дополнительную юридическую оценку
              конкретного сценария использования. Эта страница объясняет общую модель сервиса и не заменяет индивидуальное правовое заключение.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-3xl border border-zinc-700/50 bg-zinc-950/60 p-6">
            ...
            <ul className="space-y-3 text-zinc-300" style={{ fontFamily: 'Manrope, sans-serif' }}>
              ...
              <li className="flex items-start gap-3">
                <Check className="mt-0.5 h-5 w-5 flex-shrink-0 text-red-400" />
                <span>бизнес не подменяет этой моделью личные подписки и чужие стриминговые сервисы.</span>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-base sm:text-lg text-zinc-300 leading-relaxed" style={{ fontFamily: 'Manrope, sans-serif' }}>
                    В основе сервиса лежит использование не чужого музыкального каталога, а контента, который генерируется самим сервисом для
                    коммерческого применения. Поэтому модель использования отличается от обычного публичного исполнения популярной музыки.
                  </p>
                  <a
                    href="#/legal"
