...
export const messages = {
  ru: {
    ...
    stage: {
      ...
      brandedTracksDescription: "Добавляет в плейлист AI-треки, сгенерированные специально для вашего бренда.",
  ...
  en: {
    ...
    stage: {
      ...
      enableAiDjDescription: "AI-DJ speak between tracks.",
      enableAds: "Enable Ads",
      enableAdsDescription: "Enables spoken ad for your brand inserts between tracks.",
      brandedTracks: "Branded tracks",
      brandedTracksDescription: "Adds AI tracks generated specifically for your brand to the playlist.",
