...
export const messages = {
  ru: {
    ...
    auth: {
      ...
      verificationCodeSent: "Мы отправили код подтверждения на {{email}}",
      verificationCodePlaceholder: "Код из письма",
      ...
      consentPrefix: "Я даю",
      personalDataConsentLink: "согласие на обработку персональных данных",
      consentAnd: "и принимаю",
      serviceTermsLink: "условия сервиса",
      consentRequired: "Необходимо согласиться с обработкой персональных данных и условиями сервиса",
    ...
    stage: {
      ...
      enableAiDjDescription: "ИИ-диджей будет озвучивать переходы между треками.",
      enableAds: "Включить рекламные фразы",
      enableAdsDescription: "Включает голосовые рекламные вставки вашего бренда между треками.",
      brandedTracks: "Брендированные треки",
      brandedTracksDescription: "Добавляет в плейлист ИИ-треки, в тексте которых упоминается ваш бренд.",
    ...
    audioLibrary: {
      ...
      tracksCountHint: "Можно выбрать только четное число, максимум: {{count}}",
      tracksCountUnlimitedHint: "Можно выбрать любое четное число",
      unlimitedGenerations: "без ограничений",
      generationJobStatus: "Генерация запущена: {{status}}, треков: {{count}}",
      jobStatus: {
        queued: "в очереди",
        running: "в работе",
      },
  ...
  en: {
    ...
    auth: {
      ...
      verificationCodeSent: "We sent a confirmation code to {{email}}",
      verificationCodePlaceholder: "Email confirmation code",
      verificationCodeRequired: "Enter the confirmation code",
      verifyEmailButton: "Confirm email",
      emailVerificationFailed: "Email confirmation failed",
      consentPrefix: "I give",
      personalDataConsentLink: "consent to personal data processing",
      consentAnd: "and accept",
      serviceTermsLink: "the service terms",
      consentRequired: "You need to accept personal data processing and the service terms",
    ...
    stage: {
      ...
      enableAiDjDescription: "AI-DJ speaks between tracks.",
      enableAds: "Enable Ads",
      enableAdsDescription: "Enables voice ad inserts of your brand between tracks.",
      brandedTracks: "Branded tracks",
      brandedTracksDescription: "Adds AI tracks to the playlist that mention your brand.",
    ...
    audioLibrary: {
      ...
      tracksCountHint: "Only an even number is allowed, max: {{count}}",
      tracksCountUnlimitedHint: "Any even number is allowed",
      unlimitedGenerations: "unlimited",
      generationJobStatus: "Generation started: {{status}}, tracks: {{count}}",
      jobStatus: {
        queued: "queued",
        running: "running",
      },
