...
export const messages = {
  ru: {
    ...
    audioLibrary: {
      ...
      generationPartialFailed: "Часть генераций завершилась с ошибкой. Возвращено генераций: {{count}}",
  ...
  en: {
    ...
    audioLibrary: {
      ...
      generationPartialFailed: "Some generations failed. Refunded generations: {{count}}",
